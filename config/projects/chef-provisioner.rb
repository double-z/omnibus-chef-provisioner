...
homepage "https://zz.com"

# Defaults to C:/chef-provisioner on Windows
# and /opt/chef-provisioner on all other platforms
...
# # chef-provisioner dependencies/components
# # dependency "somedep"
...
dependency "chef-provisioner-cookbooks"
dependency "chef-provisioner-ctl"
dependency "chef-provisioner-deps"
